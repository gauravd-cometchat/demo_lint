...
export class CometChatSoundManager {
  ...
  static onIncomingMessage = (customSound: string | null = null): void => {
    CometChatSoundManager.audio = new Audio(
      customSound || 'https://assets.cc-cluster-2.io/uikits/static/audio/incomingmessage.wav'
    );
    CometChatSoundManager.audio.currentTime = 0;
    if (this.hasInteracted()) CometChatSoundManager.audio.play();
  };
  ...
  static onIncomingOtherMessage = (customSound: string | null = null) => {
    CometChatSoundManager.audio = new Audio(
      customSound || 'https://assets.cc-cluster-2.io/uikits/static/audio/incomingothermessage.wav'
    );
    CometChatSoundManager.audio.currentTime = 0;
    if (this.hasInteracted()) CometChatSoundManager.audio.play();
  };
  ...
  static onOutgoingMessage = (customSound: string | null = null) => {
    CometChatSoundManager.audio = new Audio(
      customSound || 'https://assets.cc-cluster-2.io/uikits/static/audio/outgoingmessage.wav'
    );
    CometChatSoundManager.audio.currentTime = 0;
    if (this.hasInteracted()) CometChatSoundManager.audio.play();
  };
  ...
  static onIncomingCall = (customSound: string | null = null) => {
    try {
      CometChatSoundManager.audio = new Audio(
        customSound || 'https://assets.cc-cluster-2.io/uikits/static/audio/incomingcall.wav'
      );
      CometChatSoundManager.audio.currentTime = 0;
  ...
  static onOutgoingCall = (customSound: string | null = null) => {
    try {
      CometChatSoundManager.audio = new Audio(
        customSound || 'https://assets.cc-cluster-2.io/uikits/static/audio/outgoingcall.wav'
      );
      CometChatSoundManager.audio.currentTime = 0;
      if (typeof CometChatSoundManager.audio.loop == 'boolean') {
        CometChatSoundManager.audio.loop = true;
  ...
  static hasInteracted() {
    if ('userActivation' in window.navigator) {
      return (
        (window.navigator.userActivation as { isActive: boolean }).isActive ||
