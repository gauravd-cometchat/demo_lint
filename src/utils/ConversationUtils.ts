...
export class ConversationUtils {
  ...
  static getLastConversationMessage(
    ...
    const msgObject: CometChat.BaseMessage = conversationObject?.getLastMessage();
    ...
    if (!msgObject) {
      ...
      msgObject?.getCategory() == CometChatUIKitConstants.MessageCategory.message &&
  ...
  static getLastMessage(conversation: CometChat.Conversation) {
    let message: string;
    const messageObject: CometChat.BaseMessage = conversation.getLastMessage();
  ...
  static getLastMessageCustom(conversation: CometChat.Conversation) {
    const msgObject: CometChat.CustomMessage = conversation.getLastMessage();
  ...
  static getLastMessageAction(conversation: CometChat.Conversation) {
    const message: CometChat.Action = conversation?.getLastMessage();
    let actionMessage = '';
    if (
  ...
  static getLastMessageCall(conversation: CometChat.Conversation) {
    const messageObject: CometChat.Action = conversation?.getLastMessage();
