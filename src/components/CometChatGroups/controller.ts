...
export class GroupsManager {
  ...
  constructor(args: Args) {
    const { searchText, groupsRequestBuilder, searchRequestBuilder, groupsSearchText } = args;
  ...
  private static createGroupListener(dispatch: React.Dispatch<Action>) {
    return new CometChat.GroupListener({
      ...
      onGroupMemberScopeChanged: async (
        message: CometChat.Action,
