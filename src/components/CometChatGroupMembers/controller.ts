...
export class GroupMembersManager {
  ...
  constructor(args: Args) {
    ...
    let finalGroupRequestBuilder =
      groupMemberRequestBuilder || new CometChat.GroupMembersRequestBuilder(groupGuid).setLimit(30);
      ...
      new CometChat.GroupListener({
        onGroupMemberScopeChanged: (
          ...
          dispatch({
            ...
            groupMemberUid: changedUser.getUid(),
            newScope,
          });
        },
        onGroupMemberKicked: (
        ...
        onMemberAddedToGroup: (
          ...
          dispatch({
            ...
            groupMember: GroupMembersManager.createParticipantGroupMember(userAdded, userAddedIn),
          });
        },
        onGroupMemberLeft: (
          message: CometChat.Action,
        ...
        onGroupMemberJoined: (
          ...
          dispatch({
            type: 'appendGroupMember',
            groupMember: GroupMembersManager.createParticipantGroupMember(joinedUser, joinedGroup),
          });
        },
      })
    );
