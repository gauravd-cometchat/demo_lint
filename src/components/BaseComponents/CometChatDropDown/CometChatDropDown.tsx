...
const CometChatDropDown = (props: DropDownProps) => {
  ...
  const { dropdownVisible, selectedOptionState, onButtonClick, onOptionClick } =
    ...
    <div className="cometchat">
      <div className="cometchat-dropdown">
        ...
        >
          ...
          <div className="cometchat-dropdown__arrow" />
        </button>
        <div
          className={
            dropdownVisible ? 'cometchat-dropdown__items' : 'cometchat-dropdown__items-hidden'
          }
        >
          {options.map((option: string, index: number) => (
            ...
            >
              <label className="cometchat-dropdown__item-label" title={option}>
                {option}
              </label>
            </div>
          ))}
