...
const CometChatVideoBubble = (props: VideoBubbleProps) => {
  const { src = '', autoPlay = false, loop = false, muted = false, isSentByMe = true } = props;
  ...
  return (
    <div className="cometchat">
      <div
        className={`cometchat-video-bubble ${isSentByMe ? 'cometchat-video-bubble-outgoing' : 'cometchat-video-bubble-incoming'}`}
      >
        <video
          controls
