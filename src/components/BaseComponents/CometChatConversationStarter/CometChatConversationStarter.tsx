...
const CometChatConversationStarter = (props: CometChatConversationStarterProps) => {
  const { getConversationStarters, onSuggestionClicked } = { ...defaultProps, ...props };
  ...
  function getErrorView(): JSX.Element | null {
    return <div className="cometchat-conversation-starter__error-view">{errorStateText}</div>;
  }
