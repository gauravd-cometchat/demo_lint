...
const CometChatAudioBubble = (props: AudioBubbleProps) => {
  ...
  const initializeWaveSurfer = useCallback(() => {
    ...
    if (waveformRef.current) {
      ...
      const barRadius = getComputedStyle(root)
        .getPropertyValue('--cometchat-radius-max')
        .trim()
        .replace('px', '');
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <div
            className="cometchat-audio-bubble__leading-view"
        ...
        <div
          className="cometchat-audio-bubble__tail-view"
          style={isLoading ? { pointerEvents: 'none' } : {}}
        >
          {isDownloading ? (
            getProgressBar()
