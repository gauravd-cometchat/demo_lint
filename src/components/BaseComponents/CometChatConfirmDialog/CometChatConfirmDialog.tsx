...
const CometChatConfirmDialog = (props: ConfirmDialogProps) => {
  ...
  return (
    <div className="cometchat" style={{ width: 'fit-content', height: 'fit-content' }}>
      {isError ? (
        <div className="cometchat-dialog-error-view cometchat-confirm-dialog-error-view">
      ...
      <div className="cometchat-confirm-dialog">
        ...
        <div className="cometchat-confirm-dialog__content">
          <div className="cometchat-confirm-dialog__content-title">{title}</div>
          <div
            className="cometchat-confirm-dialog__content-description
    "
          >
            {messageText}
          </div>
