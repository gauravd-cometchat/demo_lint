...
const CometChatChangeScope = (props: ChangeScopeProps) => {
  ...
  const { selectedValue, selectionChanged } = useCometChatChangeScope({ defaultSelection });
  ...
  return (
    <div className="cometchat">
      <div className="cometchat-change-scope">
        ...
        {isError ? (
          <div className="cometchat-change-scope__error-view">
        ...
        <div className="cometchat-change-scope__button-container">
          <div className="cometchat-change-scope__cancel-button">
            <CometChatButton
              text={getLocalizedString('change_scope_confirm_no')}
              onClick={onCloseClick}
            />
          </div>
          <div
            className={`cometchat-change-scope__submit-button ${defaultSelection == selectedValue ? 'cometchat-change-scope__submit-button-disabled' : ''}`}
          >
            <CometChatButton
              isLoading={defaultSelection !== selectedValue && isLoading}
              disabled={defaultSelection === selectedValue || isLoading}
              text={buttonText}
              onClick={scopeChangeClicked}
            />
          </div>
        </div>
      </div>
