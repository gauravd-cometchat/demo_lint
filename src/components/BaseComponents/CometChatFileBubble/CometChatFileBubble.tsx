...
const CometChatFileBubble = (props: FileBubbleProps) => {
  const { fileURL = '', fileTypeIconURL, title, subtitle, isSentByMe = true } = props;
...
"
      >
        ...
        <div
          className="cometchat-file-bubble__tail-view-download-stop"
  ...
  return (
    <div className="cometchat">
      <div
        className={`cometchat-file-bubble ${isSentByMe ? 'cometchat-file-bubble-outgoing' : 'cometchat-file-bubble-incoming'}`}
      >
        <div>
          <img
            src={fileTypeIconURL ?? filetype}
            className="cometchat-file-bubble__leading-view"
          ></img>
          <div
            className="cometchat-file-bubble__body
        "
          >
            <div className="cometchat-file-bubble__body-name">{title}</div>
        ...
        <div className="cometchat-file-bubble__tail-view">
          {isDownloading ? (
            ...
            <div className="cometchat-file-bubble__tail-view-download" onClick={downloadFile}></div>
          )}
        </div>
      </div>
    </div>
