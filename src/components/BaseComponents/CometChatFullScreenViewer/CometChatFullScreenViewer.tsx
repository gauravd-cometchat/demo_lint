...
const CometChatFullScreenViewer: React.FC<FullScreenViewerProps> = ({
  ...
  const getProgressBar = useCallback(() => {
    return (
      <div className="cometchat-fullscreen-viewer__body-download-progress">
        <svg>
          <circle
            cx="50"
            cy="50"
  ...
  function getDateFormat(): CalendarObject {
    ...
    const componentCalendarFormat = sanitizeCalendarObject(imageSentAtDateTimeFormat);
  ...
  return (
    <div className="cometchat">
      <div className="cometchat-fullscreen-viewer">
        <div className="cometchat-fullscreen-viewer__header">
          <div className="cometchat-fullscreen-viewer__header-item">
            <CometChatListItem
              ...
              subtitleView={`${CometChatLocalize.formatDate(message?.getSentAt(), getDateFormat())}`}
            />
          </div>
        </div>
        ...
        <button className="cometchat-fullscreen-viewer__close-button" onClick={handleCloseClick} />
      </div>
    </div>
  );
};
