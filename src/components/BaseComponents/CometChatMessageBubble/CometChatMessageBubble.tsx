...
const CometChatMessageBubble = (props: MessageBubbleProps) => {
  ...
  const bubbleTypeMap = {
    ...
    '_' +
    CometChatUIKitConstants.MessageCategory.message]: 'cometchat-message-bubble__text-message',
    [CometChatUIKitConstants.MessageTypes.audio +
    '_' +
    CometChatUIKitConstants.MessageCategory.message]: 'cometchat-message-bubble__audio-message',
    [CometChatUIKitConstants.MessageTypes.delete +
    '_' +
    CometChatUIKitConstants.MessageCategory.action]: 'cometchat-message-bubble__delete-message',
    [CometChatUIKitConstants.MessageTypes.file +
    '_' +
    CometChatUIKitConstants.MessageCategory.message]: 'cometchat-message-bubble__file-message',
    [CometChatUIKitConstants.MessageTypes.groupMember +
    '_' +
    CometChatUIKitConstants.MessageCategory.action]: 'cometchat-message-bubble__group-message',
    [CometChatUIKitConstants.MessageTypes.image +
    '_' +
    CometChatUIKitConstants.MessageCategory.message]: 'cometchat-message-bubble__image-message',
    [CometChatUIKitConstants.MessageTypes.video +
    '_' +
    CometChatUIKitConstants.MessageCategory.message]: 'cometchat-message-bubble__video-message',
    [CollaborativeDocumentConstants.extension_document +
    '_' +
    CometChatUIKitConstants.MessageCategory.custom]: 'cometchat-message-bubble__document-message',
    [CollaborativeWhiteboardConstants.extension_whiteboard +
    '_' +
    CometChatUIKitConstants.MessageCategory.custom]: 'cometchat-message-bubble__whiteboard-message',
    [PollsConstants.extension_poll + '_' + CometChatUIKitConstants.MessageCategory.custom]:
      'cometchat-message-bubble__poll-message',
    [StickersConstants.sticker + '_' + CometChatUIKitConstants.MessageCategory.custom]:
      'cometchat-message-bubble__sticker-message',
    [CometChatUIKitConstants.MessageTypes.audio +
    '_' +
    CometChatUIKitConstants.MessageCategory.call]: 'cometchat-message-bubble__audio-call',
    [CometChatUIKitConstants.MessageTypes.video +
    '_' +
    CometChatUIKitConstants.MessageCategory.call]: 'cometchat-message-bubble__video-call',
    [CometChatUIKitConstants.calls.meeting + '_' + CometChatUIKitConstants.MessageCategory.custom]:
      'cometchat-message-bubble__meeting-message',
    [CometChatUIKitConstants.MessageTypes.card +
    '_' +
    CometChatUIKitConstants.MessageCategory.interactive]: 'cometchat-message-bubble__card-message',
    [CometChatUIKitConstants.MessageTypes.customInteractive +
    '_' +
    CometChatUIKitConstants.MessageCategory.interactive]:
      'cometchat-message-bubble__custom-interactive-message',
    [CometChatUIKitConstants.MessageTypes.scheduler +
    '_' +
    CometChatUIKitConstants.MessageCategory.interactive]:
      'cometchat-message-bubble__scheduler-message',
    [CometChatUIKitConstants.MessageTypes.form +
    '_' +
    CometChatUIKitConstants.MessageCategory.interactive]: 'cometchat-message-bubble__form-message',
  };
  const messageRef = React.useRef<HTMLDivElement>(null);
  const bodyViewRef = React.useRef<HTMLDivElement>(null);
  ...
  const getLeadingView = () => {
    if (leadingView && alignment === MessageBubbleAlignment.left) {
      return <div className="cometchat-message-bubble__leading-view">{leadingView}</div>;
    }
  };
  /** Function to render the header view if available*/
  const getHeaderView = () => {
    if (headerView) {
      return <div className="cometchat-message-bubble__header-view">{headerView}</div>;
    }
  };
    ...
    return (
      <div
        ...
        style={{
          ...
          ...visibilityStyles,
          ...(isHovering &&
            (footerView || (!includeBottomViewHeight && bottomView) || threadView) &&
            style),
        }}
      >
  ...
  const getPlacementAlignment = () => {
    ...
    return props.alignment === MessageBubbleAlignment.left ? Placement.right : Placement.left;
  };
  ...
  return (
    ...
    >
      <div className="cometchat-message-bubble__wrapper" ref={messageRef}>
        {getLeadingView()}
          ...
          <div>
            ...
            >
              ...
              <div className="cometchat-message-bubble__body-wrapper">
                ...
                >
                  {replyView ? (
                    <div className="cometchat-message-bubble__body-reply-view"> {replyView}</div>
                  ) : null}
                  {contentView ? (
                ...
                {bottomView ? (
                  <div className="cometchat-message-bubble__body-bottom-view"> {bottomView}</div>
                ) : null}
                {footerView ? (
                  <div className="cometchat-message-bubble__body-footer-view"> {footerView}</div>
                ) : null}
                {threadView ? (
                  <div className="cometchat-message-bubble__body-thread-view"> {threadView}</div>
                ) : null}
              </div>
            </div>
          </div>
